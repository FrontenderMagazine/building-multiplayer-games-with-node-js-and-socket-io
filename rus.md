...
его с помощью команды `git clone https://github.com/ericterpstra/anagrammatix.
git` и затем выполните `npm install`, чтобы скачать и установить все 
...
последовательность действий, и игра начинается вновь.
